...
namespace LogisticRegistration
{
    ...
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            double[][] allData = LoadData("crime_homicide_binary_data.txt", 4672, 31);
            ...
            //Predition of the victim of homocide is whether Male or Female based on district,race and domestic
            ...
            if (testAccuracy1 == 1)
            {
                Console.WriteLine("L1 Prediction is Female");
                MessageBox.Show("L1 Prediction is Female");
            }
            else
            {
                Console.WriteLine("L1 Prediction is Male");
                MessageBox.Show("L1 Prediction is Male");
            }
            ...
            double testAccuracy2 = lc.Accuracy1(testArray, weights);
            if (testAccuracy2 == 1)
            {
                Console.WriteLine("L2 Prediction is Female");
                MessageBox.Show("L2 Prediction is Female");
            }
            else
            {
                Console.WriteLine("L2 Prediction is Male");
                MessageBox.Show("L2 Prediction is Male");
            }
